...
Realising this approach wasn't the best, I looked around at other ways to achieve this blog. I did some of the next-js [blog tutorials](https://nextjs.org/learn/basics/create-nextjs-app), from which I actually have the link theming I use all over the blog, but I didn't like that I had to use vercel and github to make this blog and that I had this weird looking link instead of the link you're visiting now: [legoraft.github.io](https://legoraft.github.io). So I went on looking for a way to integrate this blog with github pages.
