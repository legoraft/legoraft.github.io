...
On self-hosting services, don't think you have an SLA. You're probably giving them something new to use and you just should be clear what the ramifications are. For example, the worst thing that can happen to a jellyfin server is that people can't watch a show when they've just set up a movie night. With files, you should be more careful as people can store their sensitive and critical information on those servers (even though you told them a thousand times not to!). Just choose what people can lose or where they can suffer 9 eights of uptime instead of [8 nines](!todo).
