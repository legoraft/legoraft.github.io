...
I read a lot of posts in different technical communities, be it hacker news, reddit or github, I love lurking and reading what people think about almost everything tech-adjacent. Nobody on the internet seems to agree on anything, but a thing I see a lot of consensus on (especially within the self-host and linux community) is that you **shouldn't** be the "family IT person". I think that this shouldn't be such a cut-and-dry opinion, as there are a lot of different sides to this.
...
In science and statistics you hear a lot about the difference between correlation and causation. Most of these (admittedly, not so good) experience all happened to someone who is the family help desk. This is correlation, people who are the help desk have these experiences. This doesn't mean that this is also the cause of this behaviour. Setting up your grandma's new laptop doesn't mean she will call you thrice a day.
...
The big difference between me and my family members is that they see their computer or phone as a _tool_, not a _project_. If you give them an Arch Linux install with Hyprland, but they can't run word, they'll probably be annoyed, because the tool they have doesn't work the way they expect it. Imagine you get a drill for a few hundred bucks and it just doesn't drill holes in your wall. What use does that tool have?

This means that if you're advising family members on technical choices you got to keep in mind that they can have a significantly different view on their digital environment than you. As the person helping or advising them, this means that you need to inform them and empower them to be able to do their own things. Perhaps your grandma doesn't need a custom Arch Linux install on their laptop and she would be just as fine running a new [Macbook Neo](!todo). You should be very conscious of what your family member wants. Do they need to keep cost low? Do they run any windows-only apps? Are they daring enough to try something new?

Answering these questions means that they can have their mission-critical stuff, while you give them advice to do everything as best as possible. Every person has their own criteria for a "good" thing. This doesn't mean that you can't teach them some good principles. You can explain enough things like open source software, password managers or that the desktop isn't the place for all your files. You just shouldn't expect people to do exactly what you tell them, and sometimes their way will just be like that (also, an address book is a perfectly fine password manager if someone prefers that).

On self-hosting services, don't see that as an SLA. You're probably giving them something new to use and you just should be clear what the ramifications are. For example, the worst thing that can happen to a jellyfin server is that people can't watch a show when they've just set up a movie night. With files, you should be more careful as people can store their sensitive and critical information on those servers. Just choose what people can lose or where thay can suffer 9 eights of uptime instead of [8 nines](!todo).
