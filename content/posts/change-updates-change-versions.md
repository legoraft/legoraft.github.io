...
Mojang has done what I didn't expect, but is a great step forward. In a post about two years ago, I [wrote](@/posts/why-versioning-is-important.md) that Minecraft's versioning was getting worse with the new game drop system, making it so players and developers don't know what the latest major version is and the latest minor version is. Recently, Mojang announced in a [post](https://minecraft.net/articles/minecraft-new-version-numbering-system) on their site that they will change how Minecraft will be versioned. This is a great step towards better communication between players, developers and modders.
